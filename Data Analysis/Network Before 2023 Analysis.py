...
non_connected_nodes = [node for node, degree in G.degree() if degree == 0]
#drop non connected nodes 
G.remove_nodes_from(non_connected_nodes)
...
net.show("network_2023_prior_sep.html")
...
users_information['avg_shortest_path_before_sep_2023'] = [avg_shortest_path_length for i in range(0,len(users_information))]
